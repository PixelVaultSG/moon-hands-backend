...
async function handleHelp(ctx) {
  const helpText = [
    ...
    '`/viewconfig <client-id>` \u2013 View full config',
    '',
    '*Services:*',
    '`/addservice <client-id> <name> <price> <duration>`',
    '  \u2192 e.g.: `/addservice glow-beauty "Bridal Package" $500 180`',
    '`/updateprice <client-id> <service> <new-price>`',
    '  \u2192 e.g.: `/updateprice glow-beauty "Hair Coloring" $180`',
    '`/removeservice <client-id> <service>`',
    '',
    '*Hours & FAQ:*',
    '`/updatehours <client-id> <day> <open> <close>`',
    '  \u2192 e.g.: `/updatehours clinic Mon 09:00 18:00`',
    '`/addfaq <client-id> <question> | <answer>`',
    '  \u2192 e.g.: `/addfaq clinic "Parking?" | Yes, free at back`',
    '`/removefaq <client-id> <number>` \u2013 Remove FAQ by number',
    '',
    '*Brand Voice:*',
    '`/updatevoice <client-id> <field> <value>`',
    '  Fields: `name`, `greeting`, `tone`, `enthusiasm`, `notes`',
    '  \u2192 e.g.: `/updatevoice clinic greeting "Hey! Welcome!"`',
    '',
    '*Status:*',
    '`/pause <client-id>` \u2013 Pause AI agent',
    '`/resume <client-id>` \u2013 Resume AI agent',
    '',
    '*Reports:*',
    '`/usage <client-id>` \u2013 Today\'s usage',
    '`/health` \u2013 System health status',
    '',
    '*Security:*',
    '`/security` \u2013 Security dashboard',
    '`/threats` \u2013 Active threat list',
    '`/authlog` \u2013 Failed auth attempts (1h)',
    '',
